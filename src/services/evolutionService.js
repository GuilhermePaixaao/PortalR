...
// ======================================================
// === CORREÇÃO FEITA AQUI (FORMATO DE ENVIO) ===
// ======================================================
export const enviarTexto = async (numero, mensagem) => {
  try {
    ...
    // MUDANÇA CRÍTICA: Formato ajustado para a versão nova da Evolution API
    ...
    // Log detalhado para ajudar a debugar se acontecer de novo
    ...
    // Lança o erro para que o controller saiba que falhou
